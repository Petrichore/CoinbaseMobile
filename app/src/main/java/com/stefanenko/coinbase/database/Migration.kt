...
object Migration {
    ...
    val MIGRATION_2_3 = object : Migration(2, 3) {
        override fun migrate(database: SupportSQLiteDatabase) {
            database.execSQL(
                "create table exchange_rate_backup (id_currency Integer NOT NULL primary key, name TEXT NOT NULL, base_currency_name TEXT NOT NULL, exchange_rate Double NOT NULL, add_date  TEXT NOT NULL, add_time TEXT NOT NULL)"
            )
            ...
            database.execSQL(
                "create table exchange_rate(name TEXT NOT NULL primary key, base_currency_name TEXT NOT NULL, exchange_rate Double NOT NULL, add_date  TEXT NOT NULL, add_time TEXT NOT NULL)"
            )
